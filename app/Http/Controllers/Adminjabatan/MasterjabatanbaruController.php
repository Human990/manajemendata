...
class MasterjabatanbaruController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin-jabatan.master.master-jabatanbaru',compact(['jabatanbaru','viewIndeksData']))->with('i',($request->input('page',1)-1)*$pagination);
    }
    ...
    public function edit($kode_jabatanbaru)
    {
        ...
        return view('admin-jabatan.master.edit-jabatanbaru', compact('jabatanbaru'));
    }
    ...
    public function update(Request $request, $kode_jabatanbaru)
    {
        ...
        return redirect()->route('adminjabatan-jabatanbaru')->with('success', 'Data berhasil diupdate.');
    }
}
