...
class JabatanController extends Controller
{
    public function index(Request $request)
    {
        ...
        $datas= Jabatan::select('jabatans.kode_jabatanlama AS id', 'jabatans.nama_jabatan', 'jabatans.nilai_jabatan', 'jabatans.indeks_id', 'jabatans.tunjab', 'master_tahun.tahun', 'indeks.kelas_jabatan', 'indeks.indeks', 'jenis_jabatans.jenis_jabatan')
