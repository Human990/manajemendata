...
@section('content')
    <div class="container-fluid">
        <div class="card card-headline">
            ...
            <div class="card-body">
                <form action="{{ route('adminjabatan-jabatanbaru-update', $jabatanbaru->kode_jabatanbaru) }}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <a href="{{ route('adminjabatan-jabatanbaru') }}" class="btn btn-warning">Kembali</a>
                </form>
            </div>
        </div>
    </div>
