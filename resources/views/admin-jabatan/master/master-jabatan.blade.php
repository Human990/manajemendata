...
<div class="container-fluid">
    <div class="card card-headline">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('adminjabatan-jabatan') }}" method="GET" class="form-inline">
            ...
            aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('adminjabatan-jabatan.update', $data->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="createModalIndeks" tabindex="-1" role="dialog" aria-labelledby="createModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('adminjabatan-jabatan.store') }}" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            @csrf
