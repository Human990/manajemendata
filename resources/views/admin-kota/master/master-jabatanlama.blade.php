...
@section('content')
    <div class="container-fluid">
        <div class="card card-headline">
            ...
            <div class="card-body">
                <a href="#" class="btn btn-info" data-toggle="modal" data-target="#createModalJabatanlama">Tambah Data</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody id="dynamic-row">
                            @foreach ($jabatanlama as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->tunjab }}</td>
                                    <td>
                                        <a href="{{ route('adminkota-jabatanlama-edit', ['kode_jabatanlama' => $item->kode_jabatanlama]) }}"
