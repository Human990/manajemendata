...
@section('content')
    <div class="container-fluid">
        <div class="card card-headline">
            ...
            <div class="card-body">
                <form action="{{ route('adminkota-jabatanlama-update', $jabatanlama->kode_jabatanlama) }}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <a href="{{ route('adminkota-jabatanlama') }}" class="btn btn-warning">Kembali</a>
                </form>
            </div>
        </div>
    </div>
