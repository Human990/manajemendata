    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a href="{{ route('adminkota-tahun') }}" class="collapse-item">
                    <span>Master Tahun</span>
                </a>
                <a href="{{ route('adminkota-opd') }}" class="collapse-item">
                    <span>Master OPD</span>
                </a>
                <a href="{{ route('adminkota-indeks') }}" class="collapse-item">
                    <span>Master Indeks</span>
                </a>
                <a href="{{ route('adminkota-jabatan') }}" class="collapse-item">
                    <span>Master Jabatan</span>
                </a>
                <a href="{{ route('adminkota-rupiah') }}" class="collapse-item">
                    <span>Master Rupiah</span>
                </a>
                <a href="{{ route('adminkota-jabatanlama') }}" class="collapse-item">
                    <span>Master Jabatan Lama</span>
                </a>
                <a href="{{ route('adminkota-jabatanbaru') }}" class="collapse-item">
                    <span>Master Jabatan Baru</span>
                </a>
                <a href="{{ route('adminkota-pegawai')}}" class="collapse-item">
